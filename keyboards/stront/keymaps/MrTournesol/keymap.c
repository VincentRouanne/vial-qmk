...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [7] = { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN), ENCODER_CCW_CW(KC_RIGHT, KC_LEFT) },
    [8] = { ENCODER_CCW_CW(LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RIGHT))),          ENCODER_CCW_CW(KC_RIGHT, KC_LEFT) },
};
#endif